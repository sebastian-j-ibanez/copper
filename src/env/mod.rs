...
use crate::env::procedures::{
    ...
    exponent, floor, flush_output_port, get_output_bytevector, get_output_string, is_binary_port,
    is_boolean, is_byte_ready, is_bytevector, is_char, is_char_alphabetic, is_char_lowercase,
    is_char_numeric, is_char_ready, is_char_uppercase, is_char_whitespace, is_complex,
    is_eof_object, is_even, is_exact, is_exact_integer, is_inexact, is_input_port,
    is_input_port_open, is_integer, is_list, is_number, is_odd, is_output_port,
    ...
    open_binary_input_file, open_binary_output_file, open_input_bytevector, open_input_file,
    open_input_string, open_output_bytevector, open_output_file, open_output_string, or, peek_char,
    peek_u8, pretty_print, print, println, read_bytevector, read_char, read_into_bytevector,
    read_line, read_string, read_u8, str_append, str_length, string_to_downcase, string_to_list,
    ...
    vector_len, vector_ref, vector_set, vector_to_list, vector_to_string, write_char, write_simple,
...
impl Env {
    ...
    pub fn standard_env() -> EnvRef {
        let env_ref = Env::new();
        {
            ...
            env.insert_proc("flush-output-port", flush_output_port);
