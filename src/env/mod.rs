...
impl Env {
    ...
    pub fn standard_env() -> EnvRef {
        let env_ref = Env::new();
        {
            ...
            env.insert_proc("caar", procedures::caar);
            env.insert_proc("cadr", procedures::cadr);
            env.insert_proc("cdar", procedures::cdar);
            env.insert_proc("cddr", procedures::cddr);
            env.insert_proc("caaar", procedures::caaar);
            env.insert_proc("caadr", procedures::caadr);
            env.insert_proc("cadar", procedures::cadar);
            env.insert_proc("caddr", procedures::caddr);
            env.insert_proc("cdaar", procedures::cdaar);
            env.insert_proc("cdadr", procedures::cdadr);
            env.insert_proc("cddar", procedures::cddar);
            env.insert_proc("cdddr", procedures::cdddr);
            env.insert_proc("caaaar", procedures::caaaar);
            env.insert_proc("caaadr", procedures::caaadr);
            env.insert_proc("caadar", procedures::caadar);
            env.insert_proc("caaddr", procedures::caaddr);
            env.insert_proc("cadaar", procedures::cadaar);
            env.insert_proc("cadadr", procedures::cadadr);
            env.insert_proc("caddar", procedures::caddar);
            env.insert_proc("cadddr", procedures::cadddr);
            env.insert_proc("cdaaar", procedures::cdaaar);
            env.insert_proc("cdaadr", procedures::cdaadr);
            env.insert_proc("cdadar", procedures::cdadar);
            env.insert_proc("cdaddr", procedures::cdaddr);
            env.insert_proc("cddaar", procedures::cddaar);
